...
We can now conclude that model 2 is the worst one, Model 1 is the second best one and model 3 is the best model based on what's going with the adjusted r-squared. 
